        ...
        <div class="messaging">
            <div class="inbox_msg">
                <div class="inbox_people">
                    ...
                    <div class="inbox_chat">
                        <div
                            ...
                            class="chat_list"
                            :class="{ active_chat: item.remetente_id == ativo }"
                        >
                            <div class="chat_people">
                                ...
                                <span
                                    ...
                                    >{{ moment(item.created_at).format("MMM DD") }}</span
                                >
                            </div>
                        </div>
                    </div>
                ...
                <div class="mesgs">
                    ...
                    <div v-for="item in mensagens"
                            v-bind:key="item.id">
                        <div :class="[item.remetente_id != destinatario ? 'incoming_msg' : 'outgoing_msg']">
                            <div v-show="item.remetente_id != destinatario" class="incoming_msg_img">
                                <img
                                    class="avatar"
                                    v-bind:src="[
                                        item.remetente.foto == null
                            ...
                            <div :class="[item.remetente_id != destinatario ? 'received_msg' : 'sent_msg']">
                                <div :class="[item.remetente_id != destinatario ? 'received_withd_msg' : '']">
                                    <p>
                                        {{ item.mensagem }}
                                    </p>
